...
"Domain always wins" is false, and I want to be exact about it. GPT-4's 100k-plus vocabulary is genuinely competitive. Across a mixed probe set of drug names, gene variants, and eligibility phrases, GPT-4 averaged 4.75 tokens per term against my domain tokenizer's 5.75. A big vocabulary buys back most of the specialised advantage. The clean, controlled result is domain against general at equal vocabulary size (20-45% fewer tokens on biomedical text). It is not "beats GPT-4".
